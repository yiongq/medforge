...
**W2 核心发现**:对思考型基座(Qwen3.5),蒸馏 SFT 全线降分——换更强的老师(2024 GPT-4o → 2025 R1)能大幅止损(主力卷 -11.5pp → -3.3pp),但困难卷两代教材同伤(25.1% → 13.6%),表明「抄外部笔记」本身即破坏原生深推理,与教材质量无关。协议注记:v2 = 8192 tokens + 固定种子抽样卷(cmexam 2000 / medxpertqa 1000 / cmb 全量),v1 全量存档见 reports/runs/base/。
